  ...
  return (
    <div className="faq">
      <div
        ...
        } rounded-[10px] py-[15px] md:py-[30px] px-[15px] md:px-[40px] bg-[#141414]`}
      ...
      >
        ...
        <div className="">
          <button
            type="button"
            className="w-6 lg:w-[40px] h-6 lg:h-[40px] rounded-full flex items-center justify-center text-white bg-[#a00]"
          >
